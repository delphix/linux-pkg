...
# https://github.com/delphix/delphix-cyclonedx-cli.git once that repo exists.
#
DEFAULT_PACKAGE_GIT_URL="https://github.com/justsanjeev/delphix-cyclonedx-cli.git"
